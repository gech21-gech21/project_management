...
interface PROJECT_MANAGERTaskInteractionProps {
  taskId: string;
...
export function PROJECT_MANAGERTaskInteraction({ 
  taskId, 
  initialStatus,
  teamMembers,
  initialAssigneeId
}: PROJECT_MANAGERTaskInteractionProps) {
  ...
  const handleSendComment = async () => {
    ...
    setError(null);
    try {
      const response = await fetch(`/api/manager/tasks/${taskId}/comments`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
