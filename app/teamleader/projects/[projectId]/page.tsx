// app/teamleader/projects/[projectId]/page.tsx
"use client";
...
export default function TeamLeaderProjectPage({ params }: { params: Promise<{ projectId: string }> }) {
  ...
  const fetchProject = async () => {
    setLoading(true);
    try {
      const response = await fetch(`/api/teamleader/projects/${projectId}`);
      if (!response.ok) {
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-semibold text-gray-900">{project._count?.tasks || 0}</p>
                  </div>
                </div>
              </div>
